...
public class PostObjectSample {
    ...
    private String localFilePath = "E:\\微信开发\\小程序\\vproxy\\images\\login.png";

    private String endpoint = "https://oss.211shopper.com";
    ...
    public static String getSignature(String accessKeySecret) throws UnsupportedEncodingException, NoSuchAlgorithmException, InvalidKeyException {
