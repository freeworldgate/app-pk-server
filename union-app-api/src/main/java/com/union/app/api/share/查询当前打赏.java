...
public class 查询当前打赏 {
    ...
    @RequestMapping(path="/rewardOrder",method = RequestMethod.GET)
    @Transactional(rollbackOn = Exception.class)
    public AppResponse 查询当前打赏(@RequestParam("pkId") String pkId,@RequestParam("userId") String userId) throws AppException, IOException {


        ApplyOrder applyOrder = userInfoService.查询打赏订单(pkId,userId);
