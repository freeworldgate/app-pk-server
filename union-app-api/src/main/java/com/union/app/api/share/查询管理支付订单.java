...
public class 查询管理支付订单 {
    ...
    @RequestMapping(path="/verifyOrder",method = RequestMethod.GET)
    public AppResponse 查询管理支付订单(@RequestParam("pkId") String pkId,@RequestParam("userId") String userId) throws AppException, IOException {


        ApplyOrder applyOrder = userInfoService.查询审核支付订单(pkId,userId);
