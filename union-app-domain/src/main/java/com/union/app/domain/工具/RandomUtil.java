...
public class RandomUtil {
    ...
    public static int[] numbers = new int[]{50,100,130,160,200,250,3455,1000,2000,1100,800,400,300,500,600,700};
    public static int[] scales = new int[]{15,16,17};
...
//    }
    ...
    public static int getRandomScale() {
        Random random = new SecureRandom();
        int url = Math.abs(random.nextInt())%scales.length;
        return scales[url];
    }
}
