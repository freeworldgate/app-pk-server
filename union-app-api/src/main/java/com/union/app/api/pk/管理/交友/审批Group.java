...
public class 审批Group {
    ...
    public AppResponse 审批Group(@RequestParam("groupId") int groupId) throws AppException, IOException {
    ...
    @Transactional(rollbackOn = Exception.class)
    public AppResponse 审批UpdatingGroup(@RequestParam("groupId") int groupId) throws AppException, IOException {
